...
public class TFCOverworldBiomeBuilder {
    ...
    public TFCOverworldBiomeBuilder() {
    ...
    public List<Climate.ParameterPoint> spawnTarget() {
        Climate.Parameter parameter = Parameter.point(0.0F);
        float f = 0.16F;
        return List.of(new Climate.ParameterPoint(this.FULL_RANGE, this.FULL_RANGE, Parameter.span(this.inlandContinentalness, this.FULL_RANGE), this.FULL_RANGE, parameter, Parameter.span(-1.0F, -0.16F), 0L), new Climate.ParameterPoint(this.FULL_RANGE, this.FULL_RANGE, Parameter.span(this.inlandContinentalness, this.FULL_RANGE), this.FULL_RANGE, parameter, Parameter.span(0.16F, 1.0F), 0L));
    }
    ...
    private void addDebugBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer) {
        ...
        consumer.accept(Pair.of(Climate.parameters(this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, Parameter.point(0.0F), this.FULL_RANGE, 0.01F), Biomes.PLAINS));
        ...
        if (cubicSpline instanceof CubicSpline.Multipoint<?, ?> multipoint) {
            ...
            var10 = multipoint.locations();
            var11 = var10.length;

            for(var12 = 0; var12 < var11; ++var12) {
                f = var10[var12];
                consumer.accept(Pair.of(Climate.parameters(this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, Parameter.point(f), Parameter.point(0.0F), this.FULL_RANGE, 0.0F), resourceKey));
        ...
        if (cubicSpline2 instanceof CubicSpline.Multipoint<?, ?> multipoint2) {
            var10 = multipoint2.locations();
            var11 = var10.length;

            for(var12 = 0; var12 < var11; ++var12) {
                f = var10[var12];
                consumer.accept(Pair.of(Climate.parameters(this.FULL_RANGE, this.FULL_RANGE, Parameter.point(f), this.FULL_RANGE, Parameter.point(0.0F), this.FULL_RANGE, 0.0F), Biomes.SNOWY_TAIGA));
            }
        }
    ...
    private void addInlandBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer) {
        this.addMidSlice(consumer, Parameter.span(-1.0F, -0.93333334F));
        this.addHighSlice(consumer, Parameter.span(-0.93333334F, -0.7666667F));
        this.addPeaks(consumer, Parameter.span(-0.7666667F, -0.56666666F));
        this.addHighSlice(consumer, Parameter.span(-0.56666666F, -0.4F));
        this.addMidSlice(consumer, Parameter.span(-0.4F, -0.26666668F));
        this.addLowSlice(consumer, Parameter.span(-0.26666668F, -0.05F));
        this.addValleys(consumer, Parameter.span(-0.05F, 0.05F));
        this.addLowSlice(consumer, Parameter.span(0.05F, 0.26666668F));
        this.addMidSlice(consumer, Parameter.span(0.26666668F, 0.4F));
        this.addHighSlice(consumer, Parameter.span(0.4F, 0.56666666F));
        this.addPeaks(consumer, Parameter.span(0.56666666F, 0.7666667F));
        this.addHighSlice(consumer, Parameter.span(0.7666667F, 0.93333334F));
        this.addMidSlice(consumer, Parameter.span(0.93333334F, 1.0F));
    }
    ...
    private void addPeaks(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer, Climate.Parameter parameter) {
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.coastContinentalness, this.farInlandContinentalness), this.erosions[0], parameter, 0.0F, resourceKey7);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.coastContinentalness, this.nearInlandContinentalness), this.erosions[1], parameter, 0.0F, resourceKey3);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), this.erosions[1], parameter, 0.0F, resourceKey7);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.coastContinentalness, this.nearInlandContinentalness), Parameter.span(this.erosions[2], this.erosions[3]), parameter, 0.0F, resourceKey);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), this.erosions[2], parameter, 0.0F, resourceKey4);
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.coastContinentalness, this.farInlandContinentalness), this.erosions[4], parameter, 0.0F, resourceKey);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.coastContinentalness, this.nearInlandContinentalness), this.erosions[5], parameter, 0.0F, resourceKey6);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), this.erosions[5], parameter, 0.0F, resourceKey5);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.coastContinentalness, this.farInlandContinentalness), this.erosions[6], parameter, 0.0F, resourceKey);
            }
        }
    ...
    private void addHighSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer, Climate.Parameter parameter) {
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, this.coastContinentalness, Parameter.span(this.erosions[0], this.erosions[1]), parameter, 0.0F, resourceKey);
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), this.erosions[0], parameter, 0.0F, resourceKey8);
    ...
    private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer, Climate.Parameter parameter) {
        this.addSurfaceBiome(consumer, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Parameter.span(this.erosions[0], this.erosions[2]), parameter, 0.0F, Biomes.STONY_SHORE);
        this.addSurfaceBiome(consumer, Parameter.span(this.temperatures[1], this.temperatures[2]), this.FULL_RANGE, Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], parameter, 0.0F, Biomes.SWAMP);
        this.addSurfaceBiome(consumer, Parameter.span(this.temperatures[3], this.temperatures[4]), this.FULL_RANGE, Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], parameter, 0.0F, Biomes.MANGROVE_SWAMP);
        ...
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[0], parameter, 0.0F, resourceKey9);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.nearInlandContinentalness, this.midInlandContinentalness), this.erosions[1], parameter, 0.0F, resourceKey3);
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.coastContinentalness, this.nearInlandContinentalness), this.erosions[3], parameter, 0.0F, resourceKey);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), this.erosions[3], parameter, 0.0F, resourceKey2);
                if (parameter.max() < 0L) {
                    ...
                    this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[4], parameter, 0.0F, resourceKey);
                } else {
                    this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.coastContinentalness, this.farInlandContinentalness), this.erosions[4], parameter, 0.0F, resourceKey);
                }
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), this.erosions[5], parameter, 0.0F, resourceKey4);
                if (parameter.max() < 0L) {
                ...
                if (i == 0) {
                    this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], parameter, 0.0F, resourceKey);
                }
            }
        }
    ...
    private void addLowSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer, Climate.Parameter parameter) {
        ...
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, this.nearInlandContinentalness, Parameter.span(this.erosions[0], this.erosions[1]), parameter, 0.0F, resourceKey2);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), Parameter.span(this.erosions[0], this.erosions[1]), parameter, 0.0F, resourceKey3);
                this.addSurfaceBiome(consumer, parameter2, parameter3, this.nearInlandContinentalness, Parameter.span(this.erosions[2], this.erosions[3]), parameter, 0.0F, resourceKey);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), Parameter.span(this.erosions[2], this.erosions[3]), parameter, 0.0F, resourceKey2);
                this.addSurfaceBiome(consumer, parameter2, parameter3, this.coastContinentalness, Parameter.span(this.erosions[3], this.erosions[4]), parameter, 0.0F, resourceKey4);
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[4], parameter, 0.0F, resourceKey);
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), this.erosions[5], parameter, 0.0F, resourceKey);
    ...
    private void addValleys(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer, Climate.Parameter parameter) {
        this.addSurfaceBiome(consumer, this.FROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, Parameter.span(this.erosions[0], this.erosions[1]), parameter, 0.0F, parameter.max() < 0L ? Biomes.STONY_SHORE : Biomes.FROZEN_RIVER);
        this.addSurfaceBiome(consumer, this.UNFROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, Parameter.span(this.erosions[0], this.erosions[1]), parameter, 0.0F, parameter.max() < 0L ? Biomes.STONY_SHORE : Biomes.RIVER);
        this.addSurfaceBiome(consumer, this.FROZEN_RANGE, this.FULL_RANGE, this.nearInlandContinentalness, Parameter.span(this.erosions[0], this.erosions[1]), parameter, 0.0F, Biomes.FROZEN_RIVER);
        this.addSurfaceBiome(consumer, this.UNFROZEN_RANGE, this.FULL_RANGE, this.nearInlandContinentalness, Parameter.span(this.erosions[0], this.erosions[1]), parameter, 0.0F, Biomes.RIVER);
        this.addSurfaceBiome(consumer, this.FROZEN_RANGE, this.FULL_RANGE, Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Parameter.span(this.erosions[2], this.erosions[5]), parameter, 0.0F, Biomes.FROZEN_RIVER);
        this.addSurfaceBiome(consumer, this.UNFROZEN_RANGE, this.FULL_RANGE, Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Parameter.span(this.erosions[2], this.erosions[5]), parameter, 0.0F, Biomes.RIVER);
        ...
        this.addSurfaceBiome(consumer, Parameter.span(this.temperatures[1], this.temperatures[2]), this.FULL_RANGE, Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], parameter, 0.0F, Biomes.SWAMP);
        this.addSurfaceBiome(consumer, Parameter.span(this.temperatures[3], this.temperatures[4]), this.FULL_RANGE, Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], parameter, 0.0F, Biomes.MANGROVE_SWAMP);
        this.addSurfaceBiome(consumer, this.FROZEN_RANGE, this.FULL_RANGE, Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], parameter, 0.0F, Biomes.FROZEN_RIVER);
        ...
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                this.addSurfaceBiome(consumer, parameter2, parameter3, Parameter.span(this.midInlandContinentalness, this.farInlandContinentalness), Parameter.span(this.erosions[0], this.erosions[1]), parameter, 0.0F, resourceKey);
            }
        }
    ...
    private void addUndergroundBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer) {
        this.addUndergroundBiome(consumer, this.FULL_RANGE, this.FULL_RANGE, Parameter.span(0.8F, 1.0F), this.FULL_RANGE, this.FULL_RANGE, 0.0F, Biomes.DRIPSTONE_CAVES);
        this.addUndergroundBiome(consumer, this.FULL_RANGE, Parameter.span(0.7F, 1.0F), this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, 0.0F, Biomes.LUSH_CAVES);
        this.addBottomBiome(consumer, this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, Parameter.span(this.erosions[0], this.erosions[1]), this.FULL_RANGE, 0.0F, Biomes.DEEP_DARK);
    }
    ...
    private void addSurfaceBiome(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer, Climate.Parameter parameter, Climate.Parameter parameter2, Climate.Parameter parameter3, Climate.Parameter parameter4, Climate.Parameter parameter5, float f, ResourceKey<Biome> resourceKey) {
        consumer.accept(Pair.of(Climate.parameters(parameter, parameter2, parameter3, parameter4, Parameter.point(0.0F), parameter5, f), resourceKey));
        consumer.accept(Pair.of(Climate.parameters(parameter, parameter2, parameter3, parameter4, Parameter.point(1.0F), parameter5, f), resourceKey));
    }
    ...
    private void addUndergroundBiome(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer, Climate.Parameter parameter, Climate.Parameter parameter2, Climate.Parameter parameter3, Climate.Parameter parameter4, Climate.Parameter parameter5, float f, ResourceKey<Biome> resourceKey) {
        consumer.accept(Pair.of(Climate.parameters(parameter, parameter2, parameter3, parameter4, Parameter.span(0.2F, 0.9F), parameter5, f), resourceKey));
    }
    ...
    private void addBottomBiome(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer, Climate.Parameter parameter, Climate.Parameter parameter2, Climate.Parameter parameter3, Climate.Parameter parameter4, Climate.Parameter parameter5, float f, ResourceKey<Biome> resourceKey) {
        consumer.accept(Pair.of(Climate.parameters(parameter, parameter2, parameter3, parameter4, Parameter.point(1.1F), parameter5, f), resourceKey));
    }
    ...
    public static boolean isDeepDarkRegion(DensityFunction densityFunction, DensityFunction densityFunction2, DensityFunction.FunctionContext functionContext) {
        return densityFunction.compute(functionContext) < -0.22499999403953552 && densityFunction2.compute(functionContext) > 0.8999999761581421;
    }
